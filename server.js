...
// -------------------------------------------------------------------
// Stores: { documentId -> { info, vectorStore } }
...
app.post("/api/upload", upload.single("document"), async (req, res) => {
  try {
    ...
    // Step 3: Create Vector Store (Local Memory)
    ...
    // Store both info and the vector store instance
...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    // Step 1: Retrieve from Memory Vector Store
    ...
    // Step 3: Generate grounded answer via Groq
